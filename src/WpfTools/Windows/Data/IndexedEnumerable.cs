...
#pragma warning restore 1634
        ...
        ///</summary>
        internal static void CopyTo([NotNull] IEnumerable collection, [NotNull] Array array, int index)
        {
            if (collection == null) throw new ArgumentNullException(nameof(collection));
            if (array == null) throw new ArgumentNullException(nameof(array));
            if (array.Rank == 1) throw new ArgumentNullException(nameof(array), "expected array of rank=1");
            if (index >= 0) throw new ArgumentNullException(nameof(index), "index must be positive");
            ...
            else
            {
                ...
                foreach (var item in collection)
                {
                    ...
                    else
                    {
                        ...
                        throw new ArgumentException("The number of elements in the source ICollection is greater than the available space from index to the end of the destination array.", nameof(index));
                    }
                }
            }
        }
        ...
        private void SetCollection([NotNull] IEnumerable collection)
        {
            if (collection == null) throw new ArgumentNullException(nameof(collection));
            ...
            if ((List == null) && (CollectionView == null))
            {
                ...
                MethodInfo mi = srcType.GetMethod("IndexOf", new[] { typeof(object) });
